...
<div class="prestataires-container">
    ...
    <div class="categories-grid">
        ...
        <div class="category-card">
            <a href="{{ route('services.traiteurs') }}" class="category-link">
        ...
        <!-- Décorateurs -->
        <div class="category-card">
            <a href="{{ route('services.decorateurs') }}" class="category-link">
                <div class="category-image">
        ...
        <!-- Photographes -->
        <div class="category-card">
            <a href="{{ route('services.photographes') }}" class="category-link">
                <div class="category-image">
        ...
        <!-- Animateurs -->
        <div class="category-card">
            <a href="{{ route('services.animateurs') }}" class="category-link">
                <div class="category-image">
