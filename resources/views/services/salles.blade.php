...
<div class="wedding-halls-container">
    ...
    <div class="hero-section text-center mb-5">
        <h1 class="display-4 fw-bold  text-align: center;">Salles de Mariage Disponibles</h1>
        <p class="lead text-muted  text-align: center;">Trouvez la salle parfaite pour votre jour spécial</p>
    </div>
